...
clan_super_troops_activated = discord.ui.Select(placeholder="Select the super troop", min_values=1, max_values=1)
for s_troop in coc.SUPER_TROOP_ORDER:
    clan_super_troops_activated.add_option(label=s_troop, value=s_troop)
...
class ComponentView(discord.ui.View):
    def __init__(self, command: Union["auto_roles_bh", "auto_roles_leagues", "auto_roles_th", "buildings_bh", "buildings_th", "clan_super_troops_activated", "player_info", "joined_guild_message"]):
        ...
        elif command == "clan_super_troops_activated":
            self.add_item(clan_super_troops_activated)
