...
async def download_emojis(interaction: discord.Interaction, recreate_emojis_zip: bool):
    if recreate_emojis_zip:
        ...
        emojis_servers_id = [Ids["Emojis_coc_players_related_server"], Ids["Emojis_coc_troops_server"], Ids["Emojis_coc_super_troops_server"], Ids["Emojis_coc_heroes_server"], Ids["Emojis_coc_clans_related_server"], Ids["Emojis_coc_remains_server"], Ids["Emojis_discord_main_server"], Ids["Emojis_general_remains_server"]]
